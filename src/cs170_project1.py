...
def main():
    while (True):
        ...
        print("Enter a valid initial state. Separate each number with a comma and a space. Use 0 to represent a blank space")
        initial_state = []
        initial_state.append(input("Enter the first row: "))
        initial_state.append(input("Enter the second row: "))
        initial_state.append(input("Enter the third row: "))
    ...
    heuristics.print_state(initial_state)
